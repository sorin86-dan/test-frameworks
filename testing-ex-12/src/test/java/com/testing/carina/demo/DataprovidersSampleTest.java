...
public class DataprovidersSampleTest extends AbstractTest {
    ...
    @XlsDataSourceParameters(path = "testing-ex-9/src/test/resources/xls/demo.xlsx", sheet = "Calculator", dsUid = "TUID", dsArgs = "a,b,c", testRailColumn = "a")
    ...
    @MethodOwner(owner = "qpsdemo")
    @TestRailCases(testCasesId = "1")
    @XlsDataSourceParameters(path = "testing-ex-9/src/test/resources/xls/demo.xlsx", sheet = "Calculator", dsUid = "TUID", testRailColumn = "a")
